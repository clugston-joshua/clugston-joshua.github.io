...
\text{subject to}\ & P_{g}\leq P_{g}^{\max},\quad \forall g\in \mathcal{G}, \\
...
& P_{g} \geq 0,\quad \forall g\in \mathcal{G}, \label{power-generation} 
\end{alignat}
$$

where $M$ is very large ($\sim 100,000$).
